...
def ranked_bar(
    ...
    *,
    ...
    ax.set_xlim(0, max(values) * 1.16)  # head-room for end labels
    ...
    # headroom above the top bar for the subtitle
    ax.set_ylim(-0.8, n - 1 + 0.9)
    # title on top, quiet subtitle beneath
    if title:
